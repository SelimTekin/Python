...
plt.plot([], [], color="r", label="oyuncu2") # Oyuncu 2 nin attığı gol sayısı oyuncu 1'in gol sayısının üstüne eklenerek gösterilir
...
plt.pie(goals, labels=goal_types, colors=colors, shadow=True, explode=(0.05, 0.05, 0.05), autopct=("%1.1f%%")) # Pasta grafiği
 # explode=() dilimler arası mesafeyi belirler. autopct=() dilimlerin yüzde kaç olduğunu söyler(sondaki % sonuna yazmak için örneğin 64.8%)
