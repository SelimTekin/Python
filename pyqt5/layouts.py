...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        hlayout1.setContentsMargins(30, 20, 0, 30) # margin
        hlayout1.setSpacing(50) # her eleman arasında 50 piksel boşluk (marign)
        
        hlayout2 = QtWidgets.QHBoxLayout()
        hlayout2.addWidget(Color('red'))
        hlayout2.addWidget(Color('green'))
        hlayout2.setSpacing(20) # her eleman arasında 50 piksel boşluk (marign)
