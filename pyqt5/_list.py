...
class Window(QtWidgets.QMainWindow):
    ...
    def addStudent(self):
        ...
        text, ok = QInputDialog.getText(self, "New Student", "Student Name") # ilki başlık, ikincisi verilen mesaj

        if text and ok is not None:
            self.ui.listItems.insertItem(currentIndex, text) # seçili olan indexe(uygulama çalışır haldeyken) text'i ekle
    ...
    def editStudent(self):
        ...
        if item is not None:
            ...
            # print(text, ok) # Selim(opsiyonel) ve True yazar
            if text and ok is not None:
                item.setText(text)
    ...
    def removeStudent(self):
            ...
            if item is None:
                return # herhangi bi şey yapılmasın anlamında
