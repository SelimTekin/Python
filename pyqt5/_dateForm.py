...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dateTimeEdit.setGeometry(QtCore.QRect(320, 170, 331, 81))
        self.dateTimeEdit.setObjectName("dateTimeEdit")
        self.timeEdit = QtWidgets.QTimeEdit(self.centralwidget)
        self.timeEdit.setGeometry(QtCore.QRect(90, 170, 221, 81))
        self.timeEdit.setObjectName("timeEdit")
        self.btnCalculate = QtWidgets.QPushButton(self.centralwidget)
        self.btnCalculate.setGeometry(QtCore.QRect(90, 290, 221, 61))
        self.btnCalculate.setObjectName("btnCalculate")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(90, 70, 531, 81))
        ...
        self.dateStart.setContextMenuPolicy(QtCore.Qt.PreventContextMenu)
